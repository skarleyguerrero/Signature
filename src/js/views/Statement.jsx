          ...
          <div className="statement-view">
            <div id="top-group">
              ...
              <div id="button-group-padding" className="row d-flex justify-content-between">
                <Link to="/pay-now">
                  <button type="button" className="btn btn-primary button-color-green">Download Statement</button>
                </Link>
                ...
                <hr className="hr-overwrite" />
                  <div className="card cardStyle div-top-margin">
                    <div className="card-body row d-flex justify-content-between">
                      ...
                      <Link to="/pay-now">
                        <button id="pixel-right"  className="btn btn-primary button-color-green">Download Statement</button>
                      </Link>
                    </div>
                  </div>
                </div>
